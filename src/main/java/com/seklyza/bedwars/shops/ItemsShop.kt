...
class ItemsShop(gp: GamePlayer) : Shop(gp, "Item Shop", 54) {
    init {
        addShopItem(19, gp.team!!.type.wool, 16, Currency.IRON, 4)
        addShopItem(28, Material.OAK_PLANKS, 16, Currency.IRON, 16)
        addShopItem(37, Material.END_STONE, 12, Currency.IRON, 24)

        addShopItem(21, Material.STONE_SWORD, 1, Currency.GOLD, 4)
        addShopItem(30, Material.IRON_SWORD, 1, Currency.GOLD, 7)
        addShopItem(39, Material.DIAMOND_SWORD, 1, Currency.EMERALD, 6)

        addShopItem(23, Material.BOW, 1, Currency.GOLD, 12)
        addShopItem(32, Material.ARROW, 8, Currency.GOLD, 2)
        addShopItem(41, Material.ENDER_PEARL, 1, Currency.DIAMOND, 3)

        addShopItem(25, Material.TNT, 1, Currency.GOLD, 4)
        addShopItem(34, Material.ENCHANTED_GOLDEN_APPLE, 1, Currency.EMERALD, 3)
    }
